...
import { closeShowcaseDialog, resetCategoryDialogs, resetProductTagDialogs } from '@/stores/actions/showcase-actions'
...
export function ProductTagDetailDialog({
  currentRow,
  open,
  onOpenChange,
    ...
    >
      <DialogContent className='sm:max-w-lg'>
        <DialogHeader className='text-start'>
          <DialogTitle>Product Tag Detail</DialogTitle>
        </DialogHeader>
